...
import PlinkoSettingsScreen from "./screens/PlinkoSettingsScreen";
import PlinkoScreen from "./screens/PlinkoScreen";
import RouletteSettingsScreen from "./screens/RouletteSettingsScreen";
import RouletteScreen from "./screens/RouletteScreen";
import GambleResultsScreen from "./screens/GambleResultsScreen";
import TipPhaseScreen from "./screens/TipPhaseScreen";
...
export default function ScreenContent({ slug }: { slug: string }) {
  switch (slug) {
    ...
    case "plinko-settings": return <PlinkoSettingsScreen />;
    case "plinko": return <PlinkoScreen />;
    case "roulette-settings": return <RouletteSettingsScreen />;
    case "roulette": return <RouletteScreen />;
    case "gamble-results": return <GambleResultsScreen />;
    case "tip-phase": return <TipPhaseScreen />;
    case "leader-dashboard": return <LeaderDashboardScreen />;
    case "meal-detail": return <MealDetailScreen />;
    case "meal-history": return <MealHistoryScreen />;
    case "notifications": return <NotificationsInboxScreen />;
